...
namespace Spedit.UI.Components
{
    public class AeonEditorHighlighting : IHighlightingDefinition
    {
        ...
        public HighlightingRuleSet MainRuleSet
        {
            get
            {
                HighlightingRuleSet commentMarkerSet = new HighlightingRuleSet {Name = "CommentMarkerSet"};
                commentMarkerSet.Rules.Add(new HighlightingRule
                {
                    ...
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.CommentsMarker), FontWeight = FontWeights.Bold }
                });
                ...
                SimpleHighlightingBrush commentBrush = new SimpleHighlightingBrush(Program.Options.EditorColors.Comments);
                ...
                SimpleHighlightingBrush stringBrush = new SimpleHighlightingBrush(Program.Options.EditorColors.Strings);
                ...
                if (Program.Options.HighlightDeprecateds)
                {
                    rs.Rules.Add(new HighlightingRule //deprecated variable declaration
                    {
                        ...
                        Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.Deprecated) }
                    });
                ...
                rs.Rules.Add(new HighlightingRule //preprocessor keywords
                {
                    ...
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.PreProcessor) }
                });
                rs.Rules.Add(new HighlightingRule //type-values keywords
                {
                    Regex = RegexKeywordsHelper.GetRegexFromKeywords(new[] { "sizeof", "true", "false"}),
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.TypesValues) }
                });
                rs.Rules.Add(new HighlightingRule //main keywords
                {
                    Regex = RegexKeywordsHelper.GetRegexFromKeywords(new[] { "if", "else", "switch", "case", "default", "for", "while", "do", "break", "continue", "return", "new" }),
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.Keywords) }
                });
                rs.Rules.Add(new HighlightingRule //context keywords
                {
                    Regex = RegexKeywordsHelper.GetRegexFromKeywords(new[] { "stock", "normal", "native", "public", "static", "const", "enum", "forward"}),
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.ContextKeywords) }
                });
                rs.Rules.Add(new HighlightingRule //char type
                {
                    Regex = new Regex(@"'\\?.?'", RegexOptions.CultureInvariant | RegexOptions.ExplicitCapture),
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.Chars) }
                });
                rs.Rules.Add(new HighlightingRule //numbers
                {
                    ...
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.Numbers) }
                });
                rs.Rules.Add(new HighlightingRule //special characters
                {
                    Regex = new Regex(@"[?.;()\[\]{}+\-/%*&<>^+~!|&]+", RegexOptions.CultureInvariant | RegexOptions.ExplicitCapture),
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.SpecialCharacters) }
                });
                ...
                if (def.ConstantsStrings.Length > 0)
                {
                    rs.Rules.Add(new HighlightingRule //constants
                    {
                        ...
                        Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.Constants) }
                    });
                }
                if (def.FunctionStrings.Length > 0)
                {
                    rs.Rules.Add(new HighlightingRule //Functions
                    {
                        ...
                        Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.Functions) }
                    });
                }
                ...
                rs.Rules.Add(new HighlightingRule //unknown function calls
                {
                    ...
                    Color = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Program.Options.EditorColors.UnkownFunctions) }
                });
    ...
    public static class RegexKeywordsHelper
    {
        public static Regex GetRegexFromKeywords(string[] keywords, bool ForceAtomicRegex = false)
        {
            ...
            bool useAtomicRegex = keywords.All(t => (char.IsLetterOrDigit((t)[0])) && (char.IsLetterOrDigit((t)[t.Length - 1])));
